...
class LinkedInWatcher(BaseWatcher):
    ...
    def setup_session(self):
        ...
        print()
        print("Instructions:")
        print("  1. Wait for browser to open")
        print("  2. Navigate to: https://www.linkedin.com/feed/")
        print("  3. Log in to your LinkedIn account")
        print("  4. Wait for your feed to fully load")
        print("  5. Verify you see your LinkedIn homepage")
        print("  6. Press Ctrl+C to save session and exit")
        print()
        print("Press Enter to continue (or wait 3 seconds)...")
        ...
        # Navigate to LinkedIn with longer timeout and error handling
        print("Navigating to LinkedIn...")
        try:
            self.page.goto('https://www.linkedin.com/login', timeout=30000)
        except Exception as e:
            print(f"Note: Initial navigation had issues (this is normal): {e}")
        
        # Give user time to log in - don't wait for networkidle yet
        print("\n" + "=" * 60)
        print("Browser opened. Please log in to LinkedIn.")
        print("=" * 60)
        print("\nWaiting for you to log in (you have 2 minutes)...")
        print("Once logged in, you'll see your LinkedIn feed.")
        print("\nChecking login status every 5 seconds...")
        print("Press Ctrl+C once you see your feed and want to save the session.")
        print("=" * 60)
        ...
        while time.time() - start_time < timeout:
            try:
                ...
                if '/feed/' in current_url or '/mynetwork/' in current_url:
                    print(f"\n✅ Login detected! You're on: {current_url}")
                    logged_in = True
                    # Wait a bit more for feed to load
                    print("Waiting 5 more seconds for feed to load...")
                    time.sleep(5)
                    break
                else:
                    # Still on login page or elsewhere
                    time.sleep(5)
            except Exception as e:
                time.sleep(5)
        ...
        if not logged_in:
            ...
            print("   The browser is still open - you can continue logging in.")
            print("   Press Ctrl+C when ready to save session.")
        
        # Now wait for user to confirm and save
        print("\n" + "=" * 60)
        if logged_in:
            print("✅ SUCCESS: You are logged in to LinkedIn!")
            print("   Session will be saved when you exit.")
        else:
            print("⚠️  Please complete login if not done yet.")
        
        print("\nKeep this browser window open.")
        print("Press Ctrl+C when you see your LinkedIn feed and want to save.")
        print("=" * 60)
        ...
        try:
            ...
            try:
                ...
                print(f"   python linkedin_watcher.py \"{self.vault_path}\" --headless")
            except Exception as e:
